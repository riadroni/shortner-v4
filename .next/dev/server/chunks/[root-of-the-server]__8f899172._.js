...
"[project]/app/api/create/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (typeof id !== "string" || typeof urlMobile !== "string" || !(file instanceof File)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(uploadsDir, sanitizedFileName);
        ...
        const dataFile = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(dataDir, "links.json");
        let linksData = {};
        try {
        ...
        if (hasFlatEntries) {
            ...
            const userMap = linksData[username] ?? {};
            userMap[id] = newEntry;
            linksData[username] = userMap;
        }
        await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].writeFile(dataFile, JSON.stringify(linksData, null, 2));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8f899172._.js.map